...
const OrderDetails = ({route}) => {
 ...
 return(
  ...
  // const renderProductItem = ({ item }) => {
  //   // Unserialize the form_data
  //   const formData = unserialize(item.form_data);
  
  //   // Correctly extract the image URL and other details
  //   const productImageUrl = formData.product_iamge?.['NaN']?.['NaN'];
  //   const productName = formData.product_name?.['NaN']?.['NaN'];
  //   const productPrice = formData.product_price?.['NaN'];
  //   const quantity = formData.quantity?.['NaN'];
  
  //   console.log('Unserialized formData:', formData);
...
//     const productImageUrl = "https://example.com/product.jpg"; // Replace with actual image URL
